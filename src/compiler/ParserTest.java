...
public class ParserTest {
	...
	public void testBlockExpressionBlock() throws SyntaxException, Task2Exception {
		ArrayList<Token> tl = new ArrayList<>();
		tl.addAll(Arrays.asList(new T_LeftCurlyBracket(), new T_LeftCurlyBracket(), new T_Skip(),
				new T_RightCurlyBracket(), new T_RightCurlyBracket()));
		Block b = p.parse(tl);
