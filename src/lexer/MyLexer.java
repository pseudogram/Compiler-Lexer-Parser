...
public class MyLexer implements Lexer {
	...
	public static enum TokenType {
		...
		//
		SEMICOLON(";", new T_Semicolon()), LEFTBRACKET("[(]", new T_LeftBracket()), RIGHTBRACKET("[)]", new T_RightBracket()), EQUAL("==", new T_Equal()),
		EQUALSDEFINES("=", new T_EqualDefines()),
		LESSTHAN("<", new T_LessThan()), GREATERTHAN(">", new T_GreaterThan()), LESSEQ("<=", new T_LessEq()), GREATEREQ(">=", new T_GreaterEq()),
